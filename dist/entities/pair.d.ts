...
export declare class Pair {
    ...
    private readonly initCodeHash;
    private readonly lpTokenSymbol;
    private readonly lpTokenName;
    readonly liquidityToken: Token;
    private readonly tokenAmounts;
    static getAddress(tokenA: Token, tokenB: Token, factoryAddress: string, initCodeHash: string): string;
    constructor(tokenAmountA: TokenAmount, tokenAmountB: TokenAmount, factoryAddress: string, initCodeHash: string, lpTokenSymbol: string, lpTokenName: string);
    /**
